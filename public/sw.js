const CACHE='behta-field-v17';
const SHELL=['/','/index.html','/styles.css','/behta-enhancements.css','/field-upgrades.css','/multi-survey.css','/species-id.css','/ui-upgrades.css','/app-hotfixes.css','/field-species-tools.css','/app.js','/behta-enhancements.js','/field-upgrades.js','/confidence-persistence.js','/bng.js','/rapid-protocols.js','/multi-survey.js','/species-id.js','/term-illustrations.js','/app-hotfixes.js','/app-navigation.js','/species-fallback.js','/field-species-tools.js','/pwa.js','/manifest.webmanifest','/app-icon.svg','/field-surveys-quadrat-v2.svg','/field-surveys-quadrat-small-v2.svg','/field-surveys-brand.svg','/offline.html'];
...
function upgradedHtmlResponse(response){
  return response.text().then(html=>{
    if(!html.includes('/field-upgrades.css')) html=html.replace('</head>','  <link rel="icon" href="/field-surveys-quadrat-v2.svg" type="image/svg+xml">\n  <link rel="apple-touch-icon" href="/field-surveys-quadrat-v2.svg">\n  <meta name="mobile-web-app-capable" content="yes">\n  <meta name="apple-mobile-web-app-capable" content="yes">\n  <meta name="apple-mobile-web-app-title" content="Field Surveys">\n  <link rel="stylesheet" href="/field-upgrades.css">\n  <link rel="stylesheet" href="/multi-survey.css">\n  <link rel="stylesheet" href="/species-id.css">\n  <link rel="stylesheet" href="/ui-upgrades.css">\n  <link rel="stylesheet" href="/app-hotfixes.css">\n  <link rel="stylesheet" href="/field-species-tools.css">\n</head>');
    ...
    if(!html.includes('/app-hotfixes.css')) html=html.replace('</head>','  <link rel="stylesheet" href="/app-hotfixes.css">\n</head>');
    if(!html.includes('/field-species-tools.css')) html=html.replace('</head>','  <link rel="stylesheet" href="/field-species-tools.css">\n</head>');
    ...
    if(!html.includes('/field-species-tools.js')) html=html.replace('</body>','  <script src="/field-species-tools.js"></script>\n</body>');
