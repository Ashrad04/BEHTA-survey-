const CACHE='behta-field-v18';
const SHELL=['/','/index.html','/styles.css','/behta-enhancements.css','/field-upgrades.css','/multi-survey.css','/species-id.css','/ui-upgrades.css','/app-hotfixes.css','/field-species-tools.css','/app.js','/behta-enhancements.js','/field-upgrades.js','/confidence-persistence.js','/bng.js','/rapid-protocols.js','/multi-survey.js','/species-id.js','/term-illustrations.js','/app-hotfixes.js','/app-navigation.js','/species-fallback.js','/field-species-tools.js','/pwa.js','/manifest.webmanifest','/field-surveys-final-v3.svg','/offline.html'];
