const CACHE='behta-field-v3';
const SHELL=['/','/index.html','/styles.css','/behta-enhancements.css','/field-upgrades.css','/app.js','/behta-enhancements.js','/field-upgrades.js','/confidence-persistence.js','/pwa.js','/manifest.webmanifest','/app-icon.svg','/offline.html'];
