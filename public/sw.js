const CACHE='behta-field-v7';
const SHELL=['/','/index.html','/styles.css','/behta-enhancements.css','/field-upgrades.css','/multi-survey.css','/species-id.css','/ui-upgrades.css','/app.js','/behta-enhancements.js','/field-upgrades.js','/confidence-persistence.js','/bng.js','/rapid-protocols.js','/multi-survey.js','/species-id.js','/term-illustrations.js','/app-navigation.js','/pwa.js','/manifest.webmanifest','/app-icon.svg','/field-surveys-icon.svg','/offline.html'];
